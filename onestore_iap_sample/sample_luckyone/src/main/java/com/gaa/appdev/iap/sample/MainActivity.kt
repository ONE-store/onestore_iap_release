package com.gaa.appdev.iap.sample
...
import com.gaa.appdev.iap.sample.auth.AuthManager
import com.gaa.appdev.iap.sample.billing.AppSecurity
import com.gaa.appdev.iap.sample.billing.PurchaseManager
import com.gaa.appdev.iap.sample.common.Error
import com.gaa.appdev.iap.sample.common.ViewModelFactory
import com.gaa.appdev.iap.sample.databinding.ActivityMainBinding
import com.gaa.appdev.iap.sample.util.AppConstants
import com.gaa.appdev.iap.sample.util.LuckyUtils
import com.gaa.appdev.iap.sample.widget.BuyProductDialog
import com.gaa.appdev.iap.sample.widget.LuckyNumberView
import com.gaa.appdev.iap.sample.widget.ManageProductDialog
import com.gaa.appdev.iap.sample.widget.ResultNumberView
...
//            }
    ...
    override fun onPurchaseSucceed(purchases: List<PurchaseData>) {
        ...
        for (purchase in purchases) {
            // 구매 데이터의 유효성을 검사합니다.
            if (AppSecurity.verifyPurchase(purchase.originalJson, purchase.signature)) {
